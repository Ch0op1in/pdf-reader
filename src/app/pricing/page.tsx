import MawWidthWrapper from "@/components/MaxWidthWrapper";
import { pricingItems } from "@/lib/products";
import { cn } from "@/lib/utils";
import { getKindeServerSession } from "@kinde-oss/kinde-auth-nextjs/server"
import { TooltipProvider } from "@radix-ui/react-tooltip";
import { Plan } from "@/config/stripe"
...
const PricingPage = async () => {
    ...
    return (
        <>
          <MawWidthWrapper className='mb-8 mt-24 text-center max-w-5xl'>
                        ...
                        <div className='p-5'>
                          {plan === 'Free' ? (
                            <Link
                              ...
                              {user ? 'Go back to dashboard' : 'Sign up'}
